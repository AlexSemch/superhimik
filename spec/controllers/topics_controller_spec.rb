  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved topic as @topic" do
        ...
        post :create, {:topic => { "content" => "invalid value" }}, valid_session
        assigns(:topic).should be_a_new(Topic)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested topic" do
        ...
        Topic.any_instance.should_receive(:update).with({ "content" => "MyString" })
        put :update, {:id => topic.to_param, :topic => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the topic as @topic" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Topic.any_instance.stub(:save).and_return(false)
        put :update, {:id => topic.to_param, :topic => { "content" => "invalid value" }}, valid_session
        assigns(:topic).should eq(topic)
      end
